...
LEAGUE_CALIBRATION = {
    # Medias ajustadas ~5% abajo vs versión anterior para corregir sobreestimación de Over 2.5
    # Backtest La Liga: modelo sobreestimaba Over 2.5 en alta confianza (86% pred vs 56% real)
    # La corrección principal viene de: DC_RHO más alto (más empates), cap xG a 3.5,
    # forma_mult reducida y ELO_factor reducido — las medias base son ajuste fino.
...
def calc_all_predictions(home_form, away_form, home_gf, away_gf,
    ...
    # Blend: 45% modelo Poisson, 55% historial real
    # (backtest mostró que BTTS real ocurre 52.3% pero modelo predecía 44.3% → subpeso del historial)
    btts_yes  = round(btts_dc * 0.45 + btts_hist * 0.55, 1)
