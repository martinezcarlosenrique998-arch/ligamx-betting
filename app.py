...
LEAGUE_CALIBRATION = {
    # avg_away reducida para corregir sobreestimación de visitantes
    # Backtest La Liga 723 partidos: visitantes predecía 33.1% vs real 28.4%
    # Reducir avg_away empuja distribución a local=44%, empate=27%, visit=29% — muy cercano al real
    # Otras ligas ajustadas proporcionalmente (factor ~0.78 sobre valor anterior)
    "PL":  {"avg_home": 1.36, "avg_away": 0.86, "over25_base": 0.560, "btts_base": 0.545},
    "PD":  {"avg_home": 1.34, "avg_away": 0.85, "over25_base": 0.480, "btts_base": 0.500},
    "BL1": {"avg_home": 1.58, "avg_away": 1.02, "over25_base": 0.600, "btts_base": 0.580},
    "SA":  {"avg_home": 1.30, "avg_away": 0.81, "over25_base": 0.490, "btts_base": 0.490},
    "FL1": {"avg_home": 1.28, "avg_away": 0.84, "over25_base": 0.505, "btts_base": 0.500},
    "CL":  {"avg_home": 1.55, "avg_away": 0.85, "over25_base": 0.560, "btts_base": 0.535},
}
...
def calc_all_predictions(home_form, away_form, home_gf, away_gf,
    ...
    # Blend: 35% Poisson, 65% historial real
    # Backtest: en rangos bajos (30-40%) BTTS real era 48-52% → modelo subestimaba
    # Mayor peso al historial corrige esa subestimación sistemática
    btts_yes  = round(btts_dc * 0.35 + btts_hist * 0.65, 1)
